...
<html>
    <head>
        ...
        <title>Chỉnh sửa mục tiêu tiết kiệm</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="form-container">
                <form action="goals?action=update" method="post" id="savingsGoalForm" >
                    <input type="hidden" name="id" value="${goal.id}">

                    <div class="form-group">
                        <label for="goalName">Goal name <span class="required">*</span></label>
                        <input type="text" id="goalName" name="goalName" required value="${goal.goalName}" 
                               placeholder="Ex: Buy bike,Visitting Ha Long Bay, Repair the house">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               id="targetAmount"
                               value='<fmt:formatNumber value="${goal.targetAmount}" 
                                                                      pattern="###,###"/>'
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="savedAmount" name="savedAmount" min="0" step="1000"
                               placeholder="Nhập số tiền đã tiết kiệm" value='<fmt:formatNumber value="${goal.savedAmount}"  pattern="###,###"/>'
                               onblur="formatCurrencyField(event)" readonly>
                    </div>

                    <div class="form-group">
                        <label for="deadline">Deadline</label>
                        <input type="date" id="deadline" name="deadline" 
                               value="<fmt:formatDate value="${goal.deadline}" pattern="yyyy-MM-dd" />"
                               onchange="validateDeadlineDate(event)">
                        <span class="hint">Leave blank if there is no specific deadline</span>
                    </div>

                    <div class="goal-progress">
                        <h3>Current progress: ${goal.percentageComplete}%</h3>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="goals?action=delete&id=${goal.id}" 
                           onclick="return confirm('Bạn có chắc chắn muốn xóa mục tiêu tiết kiệm này không?')" 
                           class="button danger">Delete target</a>
