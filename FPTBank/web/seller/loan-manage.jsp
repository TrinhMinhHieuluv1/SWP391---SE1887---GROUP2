...
<style>
    ...
    <body>
        ...
        <main class="page-content">
            ...
            <form action="mangeloan" method="get" class="filter-controls">
                <!-- Search Box -->
            ...
            <table  class="news-table" border="1">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="status-column">Method</th>
                ...
                <tbody> 
                    <c:forEach items="${ListSav2}" var="f">
            ...
            <div class="pagination">
                <c:if test="${currentPage > 1}">
                    <a href="?page1=${currentPage - 1}&searchSav=${searchSav}&sortOrder=${sortOrder}&sortOrderDate=${sortOrderDate}&status=${status}&searchDate=${searchDate}&entries=${entries}"  class="prev" > Previous</a>
                </c:if>

                <c:forEach var="i" begin="1" end="${totalPages}">
                    <a href="?page1=${i}&searchSav=${searchSav}&sortOrder=${sortOrder}&sortOrderDate=${sortOrderDate}&status=${status}&searchDate=${searchDate}&entries=${entries}" class="${i == currentPage ? 'active' : ''}">${i}</a>
                </c:forEach>

                <c:if test="${currentPage < totalPages}">
                    <a href="?page1=${currentPage + 1}&searchSav=${searchSav}&sortOrder=${sortOrder}&sortOrderDate=${sortOrderDate}&status=${status}&searchDate=${searchDate}&entries=${entries}" class="next">Next</a>
                </c:if>
            </div>
