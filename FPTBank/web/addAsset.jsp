...
<html>
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <ul>
                <li><a href="myAsset_Salary.jsp">List Assets</a></li>
                <li><a href="listAssets.jsp">List Salaries</a></li>
        ...
        <div class="main-content">
            ...
            <div class="form-section">
                ...
                <form action="insertAsset" method="post" enctype="multipart/form-data">
                    ...
                    <div class="buttons">
                        <button type="button" class="cancel-btn" onclick="window.location.href = 'myassetsalary'">Cancel</button>
