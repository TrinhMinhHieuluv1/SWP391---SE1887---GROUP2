        ...
        <form action="update_serviceItemLoan" method="post">
            ...
            <div>
                ...
                <input type="text" id="maxAmount" name="maxAmount" 
                       required
                       value="<c:if test='${serviceItem.getMaxAmount() != null}'><fmt:formatNumber value='${serviceItem.getMaxAmount()}' type='number' groupingUsed='true' minFractionDigits='0' maxFractionDigits='0'/></c:if>"
                ...
                <div>
                    ...
                    <input type="text" id="maxPeriod" name="maxPeriod" 
                           required
                           value="${serviceItem.getMaxPeriod() != null && serviceItem.getMaxPeriod() != 0  ? serviceItem.getMaxPeriod() : ''}"
                    placeholder="12"
                    pattern="^[1-9][0-9]{0,2}$"
                    maxlength="3"
            ...
            <div>
                ...
                <input type="text" id="latePaymentRate" name="latePaymentRate" 
                       required
                       value="${serviceItem.getLatePaymentRate() != null && serviceItem.getLatePaymentRate() != 0.0? serviceItem.getLatePaymentRate() : ''}"
                       placeholder="1.5"
            ...
            <div>
                ...
                <input type="text" id="minCreditScore" name="minCreditScore" 
                       required
                       value="${serviceItem.getMinCreditScore() != null && serviceItem.getMinCreditScore() != 0  ? serviceItem.getMinCreditScore() : ''}"
                       placeholder="300"
                       pattern="^[0-9]{1,3}$"
                       maxlength="3"
