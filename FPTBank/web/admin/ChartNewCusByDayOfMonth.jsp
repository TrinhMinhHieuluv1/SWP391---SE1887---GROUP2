...
<!--                            <li> <a href="charts-apex.jsp"><span class="material-symbols-outlined">arrow_right</span>Apex</a>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card">
                        <div class="card-header bg-transparent py-3 d-flex align-items-center">
                            <h6 class="mb-0 text-uppercase">Statistic of new Customers for Day of month</h6>

                            <button type="button" class="btn-back" onclick="history.back();">Back</button>
                            <%                       
                                    String labels02 = (String) session.getAttribute("labels02");
                                    String data02 = (String) session.getAttribute("data02");
                                    String percentData02 = (String) session.getAttribute("percentData02");
                                    String fileDate = new SimpleDateFormat("yyyyMMdd").format(new java.util.Date());                           
                            %>

                            <form action="export_excel" method="post" class="d-flex align-items-center gap-2 ms-auto">
                                <input type="hidden" name="dataRangeType" value="Date Range">
                                <input type="hidden" name="labels" value="<%= (labels02 == null || labels02.isEmpty()) ? "null" : labels02.replaceAll("'", "") %>">
                                <input type="hidden" name="data" value="<%= (data02 == null || data02.isEmpty()) ? "null" : data02 %>">
                                <input type="hidden" name="percentages" value="<%= (percentData02 == null || percentData02.isEmpty()) ? "null" : percentData02 %>">
        ...
        <jsp:include page="assets/ChartCus/ChartNewCusOfDay.jsp"/>


        <script>
                                // Chart new cus by day of month
                                var labels01new = [<%= labels02 %>];
                                var data01new = [<%= data02%>];
