...
<html lang="en" data-bs-theme="light">
    <head>
        ...
        <link rel="icon" href="assets/images/logo-icon.png" type="image/x-icon"><!-- comment -->
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="">
                                    ...
                                    <h4 class="mb-0 text-warning">149</h4>
                                </div>
                                <div class="dropdown ms-auto">
                                    <div class="dropdown-toggle dropdown-toggle-nocaret cursor-pointer" data-bs-toggle="dropdown"><i class="bi bi-three-dots fs-4"></i>
                                    </div>
                    ...
                    <div class="card radius-10">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-auto">
                                    <div class="w_chart" id="chart12" data-percent="60">
                    ...
                    <div class="card radius-10">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-auto">
                                    <div class="w_chart" id="chart13" data-percent="60">
                                        <span class="w_percent"></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card radius-10">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-auto">
                                    <div class="w_chart" id="chart14" data-percent="60">
                                        <span class="w_percent"></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card radius-10">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-auto">
                                    <div class="w_chart" id="chart15" data-percent="60">
                                        <span class="w_percent"></span>
                                    </div>
                                </div>
                            </div>
