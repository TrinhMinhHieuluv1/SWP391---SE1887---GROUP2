...
<html>
    ...
    <div class="content">
        ...
        <form action="historytransaction" method="get">
                ...
                <button type="submit" style="background-color: green; color: white; margin-left: 15%; width: 50px; height: 30px;">Filter</button>
                ...
                <c:forEach items="${listTr}" var="transaction">
                    ...
                    <div class="transaction-card">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6 title-text">${transaction.check == false ? "Receive Money" : "Transfer Money"}</div>
                            <div class="col-6 text-end transaction-amount text-success">
                                ${transaction.check == false ? "+" : "-"} <fmt:formatNumber value="${transaction.getAmount()}" type="number" pattern="#,##0"/> VND
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-6 description-text">
                                ...
                                <c:if test="${transaction.check == true}">
                                ...
                                <c:if test="${transaction.check == false}">
                                    <c:if test="${transaction.getCustomer().getCustomerId() != transaction.getReceiver().getCustomerId()}">
