                            ...
                            <c:if test="${param.Type.equals('Unsecured')}">
                                ...
                                <c:if test="${requestScope.salary != null}">
                                    ...
                                    <div id="Salary" style="display: grid; grid-template-columns: repeat(12, 1fr); margin-top: 20px; background-color: white">
                                        <input type="text" name="SalaryID" style="display: none" value="${requestScope.salary.getId()}">
                                    ...
                                    <div id="Amount" style="position: relative; display: inline-block; width: 100%; margin-top: 20px">
                                        <input style="width: 100%; padding-right: 40px; box-sizing: border-box;" class="mil-input mil-up mil-mb-15" id="LoanAmount" type="text" placeholder="Amount to loan" name="Amount" required oninput="validateAmount()">
