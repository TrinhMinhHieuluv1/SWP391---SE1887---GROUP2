 ...
 * @author ADMIN
 */
@WebServlet(name = "ManageContractformanager", urlPatterns = {"/manager/contract-management-for-manager"})
public class ManageContractformanager extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ManageContractformanager</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ManageContractformanager at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
protected void doGet(HttpServletRequest request, HttpServletResponse response)
   ...
   HttpSession session = request.getSession();
        ...
        List<Contract> contractListBeforePagition = ctdao.selectContractListWithConditions(0, filterType, filterMonthlyPayment, filterStatus, sortBy);
