 ...
 * @author SCN
 */
@WebServlet(name = "SortListCusByCreditScore", urlPatterns = {"/admin/sortListCus_CreditScore"})
public class SortListCustomerByCreditScore extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String typeOfSort = request.getParameter("type3");
        ...
        listCustomer = cDao.sortListCustomer("CreditScore", typeOfSort, page, pageSize);
        ...
        request.setAttribute("typeOfSortByCreditScore", typeOfSort);
