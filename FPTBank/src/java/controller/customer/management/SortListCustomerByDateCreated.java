 ...
 * @author SCN
 */
@WebServlet(name = "SortListCusByDateCreated", urlPatterns = {"/admin/sortListCus_dateCreated"})
public class SortListCustomerByDateCreated extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        listCustomer = cDao.sortListCustomer("CreatedAt", typeOfSort, page, pageSize);
