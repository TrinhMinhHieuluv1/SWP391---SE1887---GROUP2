 ...
 * @author ADMIN
 */
@WebServlet(name="InActiveChartFee", urlPatterns={"/insurance/InactiveChartFee"})
public class InActiveChartFee extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InActiveChartFee</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InActiveChartFee at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
