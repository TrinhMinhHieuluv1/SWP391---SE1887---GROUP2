 ...
 * @author ADMIN
 */
@WebServlet(name="InActiveChartCover", urlPatterns={"/insurance/InactiveChartCover"})
public class InActiveChartCover extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InActiveChartCover</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InActiveChartCover at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
