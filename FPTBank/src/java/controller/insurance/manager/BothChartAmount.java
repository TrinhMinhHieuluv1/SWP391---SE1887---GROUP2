 ...
 * @author ADMIN
 */
@WebServlet(name="BothChartAmount", urlPatterns={"/insurance/BothChartAmount"})
public class BothChartAmount extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BothChartAmount</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BothChartAmount at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
