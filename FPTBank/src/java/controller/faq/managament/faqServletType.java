 ...
 * @author ADMIN
 */
@WebServlet(name="faqServletType", urlPatterns={"/faq-servlet-type"})
public class faqServletType extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet faqServletType</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet faqServletType at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    HttpSession session = request.getSession();
        ...
        int pageSize = 5; // 1 trang có 10 FAQs
