 ...
 * @author SCN
 */
@WebServlet(name = "ChartOfSavingContract", urlPatterns = {"/admin/chartSaving"})
public class ChartOfSavingContract extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        jsonResponse.put("titleOfX", "Saving Contract");
        jsonResponse.put("urlSvl", "chartSaving");
