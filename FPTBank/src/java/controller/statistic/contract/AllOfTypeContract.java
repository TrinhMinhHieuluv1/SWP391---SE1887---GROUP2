 ...
 * @author SCN
 */
@WebServlet(name = "AllOfTypeContract", urlPatterns = {"/admin/allTypeContract"})
public class AllOfTypeContract extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        jsonResponse.put("urlSvl", "allTypeContract");
        jsonResponse.put("titleOfX", "All Of Contract");
