 ...
 * @author SCN
 */
@WebServlet(name = "ChartOfUnsecuredLoan", urlPatterns = {"/admin/chartUnsecuredLoan"})
public class ChartOfUnsecuredLoan extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for (Contract contract : listContract) {
            if (contract.getStatusID() != 3 && contract.getCreateAt() != null && contract.getType().equalsIgnoreCase("Unsecured Loan")) {
        ...
        jsonResponse.put("urlSvl", "chartUnsecuredLoan");
        jsonResponse.put("titleOfX", "Unsecured Loan Contract");
