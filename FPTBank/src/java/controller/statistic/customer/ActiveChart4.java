 ...
 * @author SCN
 */
@WebServlet(name = "ActiveChart4", urlPatterns = {"/admin/ActiveChart4"})
public class ActiveChart4 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String jsonResponse = String.format(
                ...
                numOfBasic, numOfEmerging, numOfMiddle, numOfUpper, numOfVip, countActive,
