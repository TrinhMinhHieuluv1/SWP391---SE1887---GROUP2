 ...
 * @author SCN
 */
@WebServlet(name = "BothChart4", urlPatterns = {"/admin/BothChart4"})
public class BothChart4 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Double> listPercentChar4 = chart.calPercentageOfChar4(balanceOfData, listOfCus.size());
        ...
        String jsonResponse = String.format(
                ...
                numOfBasic, numOfEmerging, numOfMiddle, numOfUpper, numOfVip, listOfCus.size(),
