 ...
 * @author SCN
 */
@WebServlet(name = "ActiveChart2", urlPatterns = {"/admin/ActiveChart2"})
public class ActiveChart2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String jsonResponse = String.format(
                ...
                numOfPoor, numOfFair, numOfGood, numOfVeryGood, numOfExcellent, countActive,
