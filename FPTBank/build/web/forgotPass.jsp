                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-9">
                            <div class="mil-banner-text mil-text-center">
                                <h2 class="mil-mb-80" style="font-family: serif">Password Reset</h2>
                            </div>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="mil-blog-list mip-p-0-160">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-xl-5">
                                <form action="sendEmail" method="post" style="background: #ccffcc; padding: 30px">
                                    ...
                                    <div class="mil-up mil-mb-15">
                                        <a href="/timibank/register" class="mil-btn mil-md mil-grey mil-fw mil-mb-30">Back to login</a>
                                    </div>
                                </form>
                            </div>
                        </div>
